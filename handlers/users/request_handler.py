...
from keyboards.inline_kb import cancel_butt, return_butt, kb_maker_users, user_req, req_sender
    ...
    if cursor.rowcount > 0:
        ...
        for i in cursor.fetchall():
            ...
            text += (f'ID запроса: <b>{i[0]}</b>\n'
                     ...
                     f'Исполняющий: {i[4]}\n'
                     f'<u>Дата: {i[5]}</u>\n\n')
        await callback.message.edit_text(text=text, reply_markup=kb_maker_users(req_id))
